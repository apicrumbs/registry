...
/**
 * PostcodeIoProProvider - The Geographic Anchor for UK Data
 * Converts string postcodes into lat/lng and administrative context.
 */
class PostcodeIoProProvider extends BaseProvider
{
    public function getName(): string { return 'postcode_io_pro_context'; }
